      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <h3 className="text-gray-500 dark:text-gray-400 text-sm">Total Pets</h3>
          ...
          >
            ...
            <h3 className="text-gray-500 dark:text-gray-400 text-sm">Upcoming Appointments</h3>
          ...
          >
            ...
            <h3 className="text-gray-500 dark:text-gray-400 text-sm">Recent Activities</h3>
          ...
          >
            ...
            <h3 className="text-gray-500 dark:text-gray-400 text-sm">Health Records</h3>
            <p className="text-2xl font-semibold">View All</p>
          </motion.div>
        </div>

        {/* Pet Profiles */}
        <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Your Pets</h2>
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-300">Age: {pet.age} years</p>
